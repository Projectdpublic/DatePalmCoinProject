...
unsigned int nStakeMinAge = 0.5 * 24 * nOneHour; //  days as zero time weight
unsigned int nStakeMaxAge = 2 * 24 * nOneHour; //  days as full weight
...
const string strMessageMagic = "DatePalmCoin Signed Message:\n";
...
{
    int64_t nRewardCoinYear = 200 * CENT;
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("DatePalmCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in DatePalmCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // DatePalmCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DatePalmCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "dpc genesis";
        CTransaction txNew;
        txNew.nTime = 1518622728;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1518622728;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 3782385; // !fTestNet ? 1575379 : 46534;
