DatePalmCoin-qt: Qt4 GUI for DatePalmCoin
===============================
...
Alternatively, install Qt Creator and open the `DatePalmCoin-qt.pro` file.

An executable named `DatePalmCoin-qt` will be built.
...
A warning for people using the *static binary* version of DatePalmCoin on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of DatePalmCoin is linked against libdb5.3.
...
installed causes DatePalmCoin-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
